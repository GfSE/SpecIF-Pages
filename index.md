...
1. 'Small Automomous Vehicle' modeled using SysML: <a href="https://specif.de/apps/view.html#import=%22../examples/Small%20Autonomous%20Vehicle.specif.zip%22" target="_blank">Online Demo</a> and <a href="./examples/Small%20Autonomous%20Vehicle.specif.zip" target="_blank">ZIP-file with JSON pursuant SpecIF v1.2</a>.
