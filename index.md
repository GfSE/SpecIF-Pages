...
1. 'Small Automomous Vehicle' modeled using SysML: <a href="https://specif.de/apps/view.html#import=%22../examples/SmAV.specifz%22" target="_blank">Online Demo</a> and <a href="./examples/SmAV.specifz" target="_blank">ZIP-file with JSON pursuant SpecIF v1.1</a>.
