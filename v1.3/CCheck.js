/*!  Schema and constraint checking for native SpecIF v1.3 data in JSON format. 
...
class CCheck {
    ...
    checkConstraints( data, options ) {
        ...
        switch( data['$schema'] ) {
            case "https://specif.de/v1.3/schema#":
            ...
            default:
                return { status: 972, statusText: "Unknown schema or location" };
        };
