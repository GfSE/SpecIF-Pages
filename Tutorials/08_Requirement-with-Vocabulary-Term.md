...
You may view the example using the [SpecIF Viewer](https://specif.de/apps/view#import=../examples/v1.1/08_Requirement-with-Vocabulary-Term.specif), or download the SpecIF data:
