...
You may view the example using the [SpecIF Viewer](https://specif.de/apps/view#import=../examples/v1.1/06_Very-Simple-Model-FMC.specifz), or download the SpecIF data:
