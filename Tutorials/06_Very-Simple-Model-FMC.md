...
- v1.0: [Very Simple Model (FMC)](https://specif.de/examples/06_Very-Simple-Model-FMC.specifz)
- v1.1: [Very Simple Model (FMC)](https://github.com/GfSE/SpecIF-Examples-and-Test-cases/blob/master/examples/v1.1/06_Very-Simple-Model-FMC.specif)
