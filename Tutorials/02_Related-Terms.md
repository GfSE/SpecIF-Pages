...
You may view the example using the [SpecIF Viewer](https://specif.de/apps/view.html#import=https://specif.de/examples/v1.1/02_Related-Terms.specif), or download the SpecIF data:
