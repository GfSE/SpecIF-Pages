        ...
        function ldM(mod) {
            ...
            switch (mod) {
                case "font":
                    ...
                    return true;
                case "bootstrap":
                    getStyle("https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css");
                    getScript("https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js");
                    return true;
                case "tree":
                    loadModule('helperTree');
                    getStyle("https://cdn.jsdelivr.net/npm/jqtree@1.8.11/jqtree.css");
                    getScript('https://cdn.jsdelivr.net/npm/jqtree@1.8.11/tree.jquery.js');
                    return true;
                case "fileSaver":
                ...
                case "sysml2specif":
                    ...
                    return true;
                case 'reqif2specif':
                    getScript(loadPath + 'modules/reqif2specif.js');
                    return true;
                case 'vicinityGraph':
                    loadModule('graphViz');
