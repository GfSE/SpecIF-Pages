...
We invite you to discuss and improve the documentation:
- [Discussions](https://github.com/GfSE/SpecIF-Pages/discussions)
- [Issues](https://github.com/GfSE/SpecIF-Pages/issues)
...
The content of this repository is published at [https://gfse.github.io/SpecIF-Pages/](https://gfse.github.io/SpecIF-Pages/) using Github Pages with Jekyll and its theme [Just-the-docs](https://github.com/just-the-docs/just-the-docs) and [template](https://github.com/just-the-docs/just-the-docs-template). 
